...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_navigation__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_footer__ = __webpack_require__(4);
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('meta', { name: 'description',
        content: 'A full-service creative company experienced in branding, business strategy, and crafting share-worthy consumer experiences. We don\'t walk the line, we create it.' }),
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('style', { dangerouslySetInnerHTML: { __html: __WEBPACK_IMPORTED_MODULE_2__styles_index_scss___default.a } })
    ),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_navigation__["a" /* default */], null),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'homepage', itemScope: true, itemType: 'http://schema.org/ImageObject' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: '/static/homepage.gif', alt: 'amagazi creative agency', className: 'img-fluid' })
    ),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'homepage-mobile', itemScope: true, itemType: 'http://schema.org/ImageObject' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: '/static/homepage-m.gif', alt: 'amagazi creative agency', className: 'img-fluid' })
    ),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { 'class': 'footer-copyright py-3 text-center', itemScope: true, itemType: 'http://schema.org/WPFooter' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'p',
        null,
        '\xA9 2018 copyright |',
