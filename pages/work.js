    ...
    <div className="container-fluid">
      ...
      <div className="row top-row">
        ...
        <div className="row videos justify-content-around">
          <div className="showdeck col-md-5 order-lg-7 embed-responsive embed-responsive-16by9">
          ...
          <div className="showdeck2 col-md-5 order-lg-7 embed-responsive embed-responsive-16by9">
      ...
      <div className="row body-row">
        <div className="showdeck col-lg-8 order-lg-8">
          <img className="img-fluid float-right" src='/static/gutier.gif' alt="" />
        </div>
        <div className="subsection col-lg-4 order-lg-4">
