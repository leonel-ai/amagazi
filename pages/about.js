  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row top-row">
        <div className="showdeck col-lg-8 order-lg-8">
          <img className="img-fluid float-right" src='/static/lobby.jpg' alt="about-desktop" />
        </div>
        <div className="approach col-lg-4 order-lg-4">
          ...
          <p>We are brainy business experts, culture connoisseurs, and catalysts for getting what you want.
					...
					<br/><br/>
					<a id="cta" href="mailto:hello@amagazi.com?subject=Hello, amagazi!">Let’s talk.</a></p>
        </div>
      </div>

      <div className="row body-row">
        <div className="col-md-6 order-lg-1 mr-4">
        ...
        <div className="idea col-md-5 order-lg-2 subsection">
      ...
      <div className="row body-row">
        ...
        <div className="pt-xs-4 mt-xs-2 col-md-5 order-lg-2">
          <h1 className="title">careers</h1>
          <h2 className="subtitles">where teamwork meets amazing</h2>
          <p>Connect with us at <a id="cta" href="mailto:hello@amagazi.com?subject=Hello, amagazi careers!">hello@amagazi.com</a></p>
        </div>
      </div>
