  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row top-row">
        <div className="showdeck col-lg-8 order-lg-8 embed-responsive embed-responsive-16by9">
        ...
        <div className="approach col-lg-4 order-lg-4">
          ...
          <p>We speak human in all we create and only produce work that evokes curiosity. We create the right space
            ...
            <br/><br/>
            <a id="cta" href="mailto:hello@amagazi.com?subject=Hello, amagazi!">Let’s connect.</a></p>
        </div>
      </div>

      <div className="row body-row justify-content-center">
        <div className="services col-md-5 mr-md-4">
        ...
        <div className="motto col-md-4 subsection">
